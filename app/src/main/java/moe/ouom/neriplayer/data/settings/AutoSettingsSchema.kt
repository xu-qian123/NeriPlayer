...
object AutoSettingsSchema {
    ...
    object display {
        ...
        @AutoSetting(
            key = "nowplaying_toolbar_buttons",
            type = SettingValueType.String,
            defaultString = DEFAULT_NOWPLAYING_TOOLBAR_BUTTONS_CONFIG,
            order = 42,
            ui = SettingUiType.Custom
        )
        val nowPlayingToolbarButtons = autoSetting(
            titleRes = R.string.settings_nowplaying_toolbar_buttons,
            descriptionRes = R.string.settings_nowplaying_toolbar_buttons_desc,
